...
<body>
	...
	<div class="section divider">
		<h2 id="servicestitle">Our Brands</h2>
...
<div class="content">
    ...
    <input type="text" value="" id="newsletter_email" class="form">
    <button type="button" id="newsletter" class="btn btn-info btn-lg">Send</button>
